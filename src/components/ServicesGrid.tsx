...
const services = [
    ...
    },
    {
        icon: ShieldCheck,
        title: 'Кібербезпека',
        description: 'Аудит захищеності, впровадження політик безпеки, захист даних компанії та співробітників від актуальних загроз.'
    },
    {
        icon: Headset,
        title: 'Техпідтримка',
        description: 'Єдина точка входу для всіх звернень співробітників. Швидкі реакції, прозорі SLA та підтримка у робочий і позаробочий час.'
    }
];
            ...
            <div className="container-main">
                <div className="mb-4 text-center">
                    ...
                    <p className="mx-auto max-w-3xl text-lg text-muted-foreground">
                        6 ключових напрямків IT-аутсорсингу для стабільної та безпечної роботи вашого офісу.
                    </p>
                </div>
